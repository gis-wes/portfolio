$(document).ready(function (){
    ...
    $('#workDatabase').children().each(function(index, value) {
        ...
        newIcon.html('<div class="icons iconSize"><div class="backIcon" style="background-image: url(\''+$(value).find('#dataImage img').attr('src')+'\')"></div><div class="backIconDesc">'+$(value).find('#dataTags').html()+'</div></div>');   
    ...
    var resizeFunction = function (){
        ...
        var menuIconCount = menuIcons.length;
...
function showWork(workId,menuNav) {  
    ...
    $('#workIcon').html('<i class="workIcon ' + workData.find('#dataIcon').find('.icon').attr('class').replace('icon','') + '"></i>' );
